...
```{r, message=FALSE, echo=TRUE, warning=FALSE, size="small", eval=FALSE}
a = flexplot(weight.loss ~ motivation | gender, 
             data = exercise_data) +
              theme(axis.text.x = element_text(angle=90, hjust=1, vjust=.2))
b = flexplot(weight.loss ~ therapy.type | gender, 
...
```{r, panels, message=FALSE, echo=FALSE, warning=FALSE, eval = TRUE, size="small", fig.cap = "A multivariate plot where `therapy.type` and `gender` are now shown in panels. \\label{fig:panels}", fig.width = 8, fig.height = 8}
a = flexplot(weight.loss ~ motivation | gender, 
             data = exercise_data) +
              theme(axis.text.x = element_text(angle=90, hjust=1, vjust=.2))
b = flexplot(weight.loss ~ therapy.type | gender, 
