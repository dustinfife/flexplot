...
\authornote{I wish to thank the dozens of students who very patiently discovered bugs in the flexplot software. Your efforts have resulted in a much more robust tool.
...
\KeywordTok{flexplot}\NormalTok{(injury }\OperatorTok{~}\StringTok{ }\NormalTok{gender, }\DataTypeTok{data =}\NormalTok{ tablesaw.injury)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{b =}\StringTok{ }\KeywordTok{flexplot}\NormalTok{(weight.loss }\OperatorTok{~}\StringTok{ }\NormalTok{therapy.type }\OperatorTok{|}\StringTok{ }\NormalTok{gender, }
             \DataTypeTok{data =}\NormalTok{ exercise_data)}
\NormalTok{c =}\StringTok{ }\KeywordTok{flexplot}\NormalTok{(weight.loss }\OperatorTok{~}\StringTok{ }\NormalTok{motivation }\OperatorTok{|}\StringTok{  }\NormalTok{gender }\OperatorTok{+}\StringTok{ }\NormalTok{therapy.type, }
             \DataTypeTok{data =}\NormalTok{ exercise_data) }\OperatorTok{+}
\StringTok{      }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{facet_grid}\NormalTok{(therapy.type }\OperatorTok{~}\StringTok{ }\NormalTok{gender, }
...
\NormalTok{c =}\StringTok{ }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot_build}\NormalTok{(c)}
\NormalTok{c}\OperatorTok{$}\NormalTok{data[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{size =}\StringTok{ }\FloatTok{.25}
\NormalTok{c =}\StringTok{ }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot_gtable}\NormalTok{(c)}
\end{Highlighting}
\end{Shaded}
