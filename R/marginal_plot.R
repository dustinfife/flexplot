...
# marginal_plot2 = function(p, columns=TRUE, rows=TRUE, grand_mean=TRUE) {
#   browser()
...
#   panel_number = plot_data$PANEL %>% unique
#   
#   # map panel number to variables
#   # get panels numbers for just the first element
# 
#   
#   g1 = ggplotGrob(p)
