...
.glinmod_compute = function(jaspResults, dataset, options) {
  ...
  ## interactions are stored in a deeply nested list. delistify them
  predictors = paste0(
    unlist(
...
.create_glinmod_table_differences <- function(jaspResults, dataset, options, ready) {
